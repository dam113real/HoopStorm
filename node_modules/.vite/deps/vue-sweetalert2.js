...
`, Ye = (e, t) => {
      ...
      return g(e.querySelectorAll("swal-param")).forEach((n) => {
        ...
        typeof V[o] == "boolean" && s === "false" && (t[o] = false), typeof V[o] == "object" && (t[o] = JSON.parse(s));
      }), t;
    }, Bn = (e) => {
      const t = {};
...
`).join("<br />")), Nt(e);
    ...
    const Dn = () => {
      ...
      return Rn(e) || Un(e) ? false : t === n || !Ue(n) && t.tagName !== "INPUT" && // #1603
      ...
      t || new de(), t = u();
      const n = q();
      ce() ? b($()) : Zn(t, e), p(n), t.setAttribute("data-loading", true), t.setAttribute("aria-busy", true), t.focus();
    }, Zn = (e, t) => {
      const n = J(), o = q();
      ...
      select: (e, t, n) => {
        ...
        t.forEach((r) => {
          ...
          if (Array.isArray(v)) {
            ...
            y.label = f, y.disabled = false, o.appendChild(y), v.forEach((N) => s(y, N[1], N[0]));
          } else
            s(o, v, f);
        }), o.focus();
      },
    ...
    function nt() {
      ...
      b(t.loader), ce() ? e.icon && p($()) : oo(t), E([t.popup, t.actions], i.loading), t.popup.removeAttribute("aria-busy"), t.popup.removeAttribute("data-loading"), t.confirmButton.disabled = false, t.denyButton.disabled = false, t.cancelButton.disabled = false;
    }
    const oo = (e) => {
    ...
    function ot(e, t, n, o) {
      ...
      }), c.keydownHandlerAdded = false), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (t.setAttribute("style", "display:none !important"), t.removeAttribute("class"), t.innerHTML = "") : t.remove(), be() && (jn(), Nn(), Je()), so();
    }
    function so() {
    ...
    const co = (e) => {
      ...
      const o = h();
      return E(o, n.showClass.backdrop), a(o, n.hideClass.backdrop), uo(e, t, n), true;
    };
    function lo(e) {
...
If you think this parameter should be updatable, request it here: https://github.com/sweetalert2/sweetalert2/issues/new?template=02_feature_request.md`));
    ...
    const ko = (e) => {
      ...
      n.showLoaderOnDeny && R(O()), n.preDeny ? (l.awaitingPromise.set(e || void 0, true), Promise.resolve().then(() => _(n.preDeny(t, n.validationMessage))).then((s) => {
      ...
      const n = l.innerParams.get(e || void 0);
      n.showLoaderOnConfirm && R(), n.preConfirm ? (e.resetValidationMessage(), l.awaitingPromise.set(e || void 0, true), Promise.resolve().then(() => _(n.preConfirm(t, n.validationMessage))).then((s) => {
        C(se()) || s === false ? (e.hideLoading(), te(e)) : ut(e, typeof s > "u" ? t : s);
    ...
    const Io = (e) => {
      e.popup.onmousedown = () => {
        e.container.onmouseup = function(t) {
          e.container.onmouseup = void 0, t.target === e.container && (ue = true);
        };
      };
    }, Lo = (e) => {
      e.container.onmousedown = () => {
        e.popup.onmouseup = function(t) {
          e.popup.onmouseup = void 0, (t.target === e.popup || e.popup.contains(t.target)) && (ue = true);
        };
      };
    }, Mo = (e, t, n) => {
      ...
      }), t.keydownHandlerAdded = false), n.toast || (t.keydownHandler = (s) => Fo(e, s, o), t.keydownTarget = n.keydownListenerCapture ? window : u(), t.keydownListenerCapture = n.keydownListenerCapture, t.keydownTarget.addEventListener("keydown", t.keydownHandler, {
        capture: t.keydownListenerCapture
    ...
    function Xo() {
      ...
      xe[e] = this, bt || (document.body.addEventListener("click", Qo), bt = true);
    }
    const Qo = (e) => {
    ...
    }, ri = (e, t) => t.focusDeny && C(e.denyButton) ? (e.denyButton.focus(), true) : t.focusCancel && C(e.cancelButton) ? (e.cancelButton.focus(), true) : t.focusConfirm && C(e.confirmButton) ? (e.confirmButton.focus(), true) : false, ci = () => {
